...
from src.views.attendance_management_view import AttendanceManagementView
...
class AttendanceManagementController:
    ...
    def __init__(self, app: Any, router: Any):
        self.app = app
        self.router = router
        self.service = AttendanceManagementService()
        self.view: AttendanceManagementView | None = None

    def build_view(self) -> AttendanceManagementView:
        self.view = AttendanceManagementView(
            self.app.root,
